...
function HeroSection(): JSX.Element {
  return (
    <section className="green-dotted-bg w-full overflow-y-hidden 1240px:h-[100vh] py-20 1240px:py-0 1240px:mt-[-1.8cm] flex justify-center items-center overflow-x-hidden">
